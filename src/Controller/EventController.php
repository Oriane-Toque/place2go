...
class EventController extends AbstractController
{
	 ...
	 * @return Response
	 */
	public function join(Event $event, EntityManagerInterface $em, Request $request, AttendantRepository $ar, isAttendant $isAttendant): Response
	{
		...
		$isAttendant = $isAttendant->checkIsAttendant($attendantList, $user);
	 ...
	 * @return Response
	 */
	public function leave(Event $event, AttendantRepository $ar, EntityManagerInterface $em, Request $request, isAttendant $isAttendant): Response
	{
		$user = $this->getUser();
